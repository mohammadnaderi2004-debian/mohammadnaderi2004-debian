<h1 align="center" style="margin-bottom:0; font-size:2.5em;">𝐇𝐢, 𝐈’𝐦 𝐌𝐨𝐡𝐚𝐦𝐦𝐚𝐝 𝐍𝐚𝐝𝐞𝐫𝐢 👋</h1>
<h3 align="center" style="margin:0.2em 0 0 0;">
  Front-End Developer | Linux & Open-Source Advocate | Exploring Networking & Cybersecurity
</h3>
...
<li>💻 Front-End Developer (HTML, CSS, JavaScript, Django)</li>
<li>🐧 Linux User (Arch Linux) & continuous learner</li>
<li>🌐 Interested in Networking, Cybersecurity & Blockchain</li>
<li>⚡ Intermediate knowledge of C, C++, Python</li>
<li>📚 Currently learning OWASP, Linux & Bash, Network, ASP.NET</li>
